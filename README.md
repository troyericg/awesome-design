...
- [Resources](#resources)
    ...
    - [Colors](#colors)
    - [CSS](#css)
    - [Grids/Structure](#grids-structure)
    - [Icons & Entities](#icons-entities)
    - [Images](#images)
...
* [PXtoEM](conversion site - http://pxtoem.com/)
...
* [Color Brewer (for maps)](http://colorbrewer2.org/)
...
* [Rainbow Text Maker](http://rainbow.arch.scriptmania.com/tools/rainbow_text/rainbow_text.html)
* [The Day’s Color](http://thedayscolor.com/)
...
* [CopyPasteCharacter (HTML Entities)](http://copypastecharacter.com/)
* [Favicon Generator](http://www.favicon.cc/)
* [iOS 7 App Icon Template for Obsessive Designers](http://savvyapps.com/blog/ios-7-app-icon-template-obsessive-designers/)
* [Loading GIF Generator](http://ajaxload.info/)
...
### Contribution
Please contribute! We all get better when we do it together.